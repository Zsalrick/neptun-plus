...
async function deleteProfile(id) {
  ...
  for (const m of ((wasActive ? state.materials : p.materials) || []).concat((wasActive ? state.books : p.books) || [], (wasActive ? state.quizzes : p.quizzes) || [])) { try { await matDeleteData(m.id); } catch (e) {} }
