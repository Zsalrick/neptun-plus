...
function renderPlans() {
  ...
  $("plan-new").onclick = async () => {
    const nm = await askText({ title: "Új tervezet", placeholder: "Például: 2026/27/1 terv", value: "", body: "Adj nevet a tervezetnek. Több tervezeted is lehet egymás mellett." });
    if (nm == null) return;
